...
public class SupportController {
	...
	/* (추가) 수정 & 삭제 는 isReplied 가 false 일 경우만 가능하도록 구현 */
	...
	public ResponseEntity<SupportResponseDto> getSupport(@PathVariable Long supportId) {
		SupportResponseDto responseDto = supportService.getSupport(supportId);
	...
	public ResponseEntity<String> deleteSupport(@PathVariable Long supportId) {    /* (추후) 토큰으로 관리자 인증 */
